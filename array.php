...
<body>
    ...
    echo "Panjang Array Kids: " . count($kids) . "<br>";
    echo "Panjang Array Adults: " . count($adults) . "<br>";
    ...
    */
    ...
    echo "Daftar Cast Stranger Things: <br>";
    echo "<ul>";
    foreach ($strangerThingsCast as $cast) {
        echo "<li>";
        echo "Name: " . $cast["Name"] . ", ";
        echo "Age: " . $cast["Age"] . ", ";
        echo "Aliases: " . $cast["Aliases"] . ", ";
        echo "Status: " . $cast["Status"];
        echo "</li>";
    }
    echo "</ul>";
    ?>
